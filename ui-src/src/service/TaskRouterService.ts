...
class TaskRouterService extends ApiService {
  ...
  updateTaskAssignmentStatuss = async (
    ...
    return this.fetchJsonWithReject<UpdateTaskAttributesResponse>(
      `https://${this.serverlessDomain}/disposition/update-task-assignment-status`,
      {
        method: 'post',
  ...
  getQueuess = async (): Promise<GetQueuesResponse> => {
    ...
    return this.fetchJsonWithReject<GetQueuesResponse>(
      `https://${this.serverlessDomain}/disposition/get-queues`,
      {
        method: 'post',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: this.buildBody(encodedParams),
  ...
  getWorkerChannelss = async (workerSid: string): Promise<GetWorkerChannelsResponse> => {
    ...
    return this.fetchJsonWithReject<GetWorkerChannelsResponse>(
      `https://${this.serverlessDomain}/disposition/get-worker-channels`,
      {
        method: 'post',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: this.buildBody(encodedParams),
  ...
  updateWorkerChannels = async (
    ...
    return this.fetchJsonWithReject<UpdateWorkerChannelResponse>(
      `https://${this.serverlessDomain}/disposition/update-worker-channel`,
      {
        method: 'post',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: this.buildBody(encodedParams),
